    ...
    <main className="about-container">
      <section className="A-intro">
        ...
        <div className="image-overlay-wrapper">
            <img src={`${process.env.PUBLIC_URL}/images/Bamboo.webp`} alt="Mission visual" className="A-intro-image" />
      ...
      <section className="A-about-section">
        ...
        <div className="A-about-image-wrapper">
          <img src={`${process.env.PUBLIC_URL}/images/Yoga.webp`} alt="forest" className="A-about-image" />
